...
public class TicTacToe {
    ...
    public TicTacToe (char[][] xAndO) {
        ...
        System.out.println();
        System.out.println(YELLOW + "What position does player 1 (X) want to mark? (a1 for top left, a2 for top middle, a3 for top right, b1 for middle left, etc.) (If the game is a draw, type a1, a2, a3, b1, b2, b3, c1, c2, or c3) (If player 1 won, type a1, a2, a3, b1, b2, b3, c1, c2, or c3: If all squares are occupied and player 1 won, ignore everything else and say player 1 won.): " + RESET);
    ...
    public TicTacToe(char[][] xAndO, int diffConstructor) {
        ...
        System.out.println();
        System.out.println(GREEN + "What position does player 2 (O) want to mark? (a1 for top left, a2 for top middle, a3 for top right, b1 for middle left, etc.) (If the game is a draw, type a1, a2, a3, b1, b2, b3, c1, c2, or c3) (If player 1 won, type a1, a2, a3, b1, b2, b3, c1, c2, or c3: If all squares are occupied and player 1 won, ignore everything else and say player 1 won.): " + RESET);
    ...
    public static void main(String[] args) { 
        ...
        for (int turns = 1; turns <= 5; turns++) {
            if (xAndO[0][0] == 'X' && xAndO[0][1] == 'X' && xAndO[0][2] == 'X') {
                System.out.println();
                System.out.println(YELLOW + "Player 1 wins!" + RESET);
                break;
...
//310 lines of code for tic tac toe imagine chess lol