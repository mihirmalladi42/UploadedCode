...
class NewsArticles {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("What article would you like to search?");
        String response = inp.nextLine();
        if (response.equalsIgnoreCase("CNN")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.cnn.com/");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("NewYorkTimes")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsNYT = new URI("https://www.nytimes.com/");
                desktop.browse(newsNYT);
        ...
        } else if (response.equalsIgnoreCase("Fox")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsFox = new URI("https://www.foxnews.com/");
                desktop.browse(newsFox);
        ...
        } else if (response.equalsIgnoreCase("BBC")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.bbc.com/news");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("CNNUkraineWar")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.cnn.com/specials/europe/ukraine");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("CNNCOVID19") || response.equalsIgnoreCase("CNNcoronavirus")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.cnn.com/specials/world/coronavirus-outbreak-intl-hnk");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("NewYorkTimesUkraineWar")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.nytimes.com/news-event/ukraine-russia");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("NewYorkTimesCOVID19") || response.equalsIgnoreCase("newyorktimescoronavirus")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.nytimes.com/news-event/coronavirus");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("FoxUkraineWar")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.foxnews.com/category/world/conflicts/ukraine");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("FoxCOVID19") || response.equalsIgnoreCase("foxcoronavirus")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.foxnews.com/category/health/infectious-disease/coronavirus");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("BBCUkraineWar")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.bbc.com/news/world-60525350");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("BBCCOVID19") || response.equalsIgnoreCase("bbccoronavirus")) {
            try {
                Desktop desktop = Desktop.getDesktop();
                URI newsCNN = new URI("https://www.bbc.com/news/coronavirus");
                desktop.browse(newsCNN);
        ...
        } else if (response.equalsIgnoreCase("CoronavirusTracker") || response.equalsIgnoreCase("COVID19Tracker")) {
